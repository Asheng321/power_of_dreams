...
public class HalfFlush extends EatAndDecreaseHand {
	...
	protected boolean isApplicable(WinningPlayerHand winningPlayerHand) {
		...
		return tileTypes.equals(EnumSet.of(TileType.MANZU, TileType.JIHAI))
				|| tileTypes.equals(EnumSet.of(TileType.PINZU, TileType.JIHAI))
				|| tileTypes.equals(EnumSet.of(TileType.SOUZU, TileType.JIHAI));
	}
